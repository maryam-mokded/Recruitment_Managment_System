                                  ...
                                  child: Container(
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          Text(
                                            "Commerciaux terrain en Microfinance",
                                          ...
                                          Row(
                                            ...
                                            children: <Widget>[
                                              Text(
                                                'Réaliser des actions de prospecti...',
                                                style: TextStyle(
                                                    fontSize: 14,
                                                    color: Colors.grey
                                                        .withOpacity(0.8)),
                                      ...
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          ...
                                          Row(
                                            ...
                                            children: <Widget>[
                                              Text(
                                               "Gestion d'une équipe de téléven...",
                                                    style: TextStyle(
                                                    fontSize: 14,
                                                    color: Colors.grey
                                                        .withOpacity(0.8)),
