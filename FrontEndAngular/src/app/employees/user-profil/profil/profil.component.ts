...
export class ProfilComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.route.paramMap.subscribe(params => {
      ...
      this.authService.getEmployeeProfile(idUser).subscribe(employee => {
        this.employee = employee,
        this.localStorageService.set('user', {email: employee.email, id: employee._id, name: employee.username});
      });
    });
  }
